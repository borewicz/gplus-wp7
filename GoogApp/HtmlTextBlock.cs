...
namespace GoogApp
{
    public class HtmlTextBlock : Control
    {
        ...
        // Variables
        protected RichTextBox _textBlock;
        ...
        public HtmlTextBlock()
        {
            ...
            _textBlock.Padding = new Thickness(-12, 0, 0, 0);
        ...
        public override void OnApplyTemplate()
        {
            ...
            _textBlock = GetTemplateChild("RichTextBox") as RichTextBox;
        }
        ...
        protected void ParseAndSetText(string text)
        {
            ...
            {
                // Try to parse as-is
                text = text.Replace("<br>", "<br/>");  // Firefox
                text = text.Replace("<BR>", "<BR/>");  // Internet Explorer
            ...
            if (!success && UseDomAsParser)
            {
                ...
                foreach (var bodyObject in document.DocumentNode.Descendants("body"))
                {
                            ...
                            case XmlNodeType.Element:
                                ...
                                switch (nameUpper)
                                {
                                    case elementA:
                                        ...
                                        if (xmlReader.MoveToFirstAttribute())
                                        {
                                            do
                                            {
                                                if ("HREF" == xmlReader.Name.ToUpper())
                                                {
                                                    ...
                                                    if (xmlReader.Name.ToUpper() == "CLASS")
                                                    {
                                                        if (xmlReader.Value == "proflink") proflink = true;
                                                        xmlReader.MoveToNextAttribute();
                                                        if (xmlReader.Name.ToUpper() == "OID")
                                                            oid = xmlReader.Value;
                                                    }
                                                    break;
                                                }
                                        ...
                                        break;
                                    case elementB: bold++; break;
                                    case elementSTRONG: bold++; break;
                                    case elementI: italic++; break;
                                    case elementEM: italic++; break;
                                    case elementU: underline++; break;
                                    case elementBR: paragraph.Inlines.Add(new LineBreak()); break;
                                    case elementP:
                            ...
                            case XmlNodeType.Whitespace:
                                ...
                                if (0 < builderString.Length)
                                {
                                    ...
                                    if (null != link)
                                    {
                                       ...
                                       // var linkRun = new Run { Text = builderString };
                                        ...
                                        if (proflink == false)
                                        {
                                            ...
                                            hyperlink.NavigateUri = new Uri("/Profile.xaml?userID=" + oid, UriKind.Relative);                                    
